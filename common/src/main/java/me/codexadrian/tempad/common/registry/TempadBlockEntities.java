...
public class TempadBlockEntities {
    ...
    public static final RegistryEntry<BlockEntityType<?>> WARP_PAD = REGISTRY.register("warp_pad", () -> BlockEntityType.Builder.of(WarpBlockEntity::new, TempadBlocks.WARP_PAD.get()).build(null));
    public static final RegistryEntry<BlockEntityType<?>> LOCATION_TERMINAL = REGISTRY.register("location_terminal", () -> BlockEntityType.Builder.of(LocationPrinterBlockEntity::new, TempadBlocks.LOCATION_TERMINAL.get()).build(null));
}
